...
export function buildExplanation(
  ...
  return `Based on your last 14 days of data, your estimated real TDEE is ${result.estimatedTdee} kcal. We've ${delta > 0 ? "increased" : "decreased"} your daily target by ${Math.abs(delta)} kcal to better match your actual metabolism.`;
}
