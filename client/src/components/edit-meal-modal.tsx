                      ...
                      return (
                        <div key={ing.key} className="bg-white rounded-xl border border-zinc-100 p-2.5 sm:p-3 space-y-1.5">
                          <div className="flex items-center gap-1.5 sm:gap-2">
                            ...
                            {isLinked && (
                              <span className="shrink-0 px-1.5 py-0.5 rounded-md bg-emerald-50 text-emerald-600 text-[9px] font-semibold tracking-wide hidden min-[400px]:inline">FuelU DB</span>
                            )}
