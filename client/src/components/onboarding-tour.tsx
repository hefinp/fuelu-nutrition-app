...
const STEPS = [
  ...
  },
  {
    ...
    description: "Start by entering your weight, height, age, and fitness goal. NutriSync calculates your daily calorie target and a personalised protein, carbs, and fat breakdown.",
  ...
  },
  {
    ...
    description: "Import recipes from your favourite websites. NutriSync extracts the nutrition info and can include them in your generated meal plans.",
