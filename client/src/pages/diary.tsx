  ...
  return (
    <div className="bg-orange-50/40 border border-orange-100 rounded-xl p-3 mb-3" data-testid="diary-activity-section">
      ...
      <div className="space-y-1.5">
        {activities.map((a) => (
          <div key={a.id} data-testid={`diary-activity-${a.id}`}>
            ...
            {a.deviceType && /garmin/i.test(a.deviceType) && (
              <p className="text-[10px] text-zinc-400 ml-10 -mt-0.5" data-testid={`diary-garmin-attr-${a.id}`}>Recorded with Garmin</p>
            )}
          </div>
        ))}
      </div>
      <div className="flex justify-center pt-2" data-testid="diary-strava-powered-badge">
