      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="prose prose-zinc max-w-none space-y-8 text-zinc-700 leading-relaxed text-[15px]">
          <section>
            ...
            <p>By creating an account or using NutriSync you agree to these Terms of Service. If you do not agree, please do not use the service.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">2. Description of Service</h2>
            <p>NutriSync is a nutrition calculator and meal-planning tool. It provides estimated calorie targets, macronutrient breakdowns, and sample meal plans based on the body metrics and goals you supply. The service is provided free of charge.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">3. Health Disclaimer</h2>
            <p>NutriSync is not a medical service. All calorie targets, macro breakdowns, and meal plans are estimates based on widely used formulas (Mifflin-St Jeor) and should not be treated as medical advice. You should consult a qualified healthcare professional before making significant dietary changes, especially if you have a medical condition, food allergies, or special nutritional needs.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">4. User Accounts</h2>
            <p>You are responsible for maintaining the confidentiality of your account credentials. You agree to provide accurate information when creating your account and using the calculator. NutriSync reserves the right to suspend or terminate accounts that violate these terms.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">5. Limitation of Liability</h2>
            <p>NutriSync and its operators shall not be held liable for any direct, indirect, incidental, or consequential damages arising from your use of the service, including but not limited to health outcomes resulting from following generated meal plans. The service is provided &ldquo;as is&rdquo; without warranties of any kind.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-zinc-900 mb-3">6. Intellectual Property</h2>
            <p>All content, design, and code comprising NutriSync are the property of its operators. You may not reproduce, distribute, or create derivative works from the service without prior written consent.</p>
          </section>
          ...
          <section>
            ...
            <p>These terms are governed by applicable law. Any disputes arising from the use of NutriSync shall be resolved in accordance with the jurisdiction of the service operator.</p>
          </section>
        </div>
      </main>
